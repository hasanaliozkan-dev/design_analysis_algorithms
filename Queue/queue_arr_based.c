...
//Returns whether queue is empty or not by cjhecking the queueu. 
int isEmpty(){return queue == 0;}
//return the frontest element without remove it.
int peek(){
    if(isEmpty()){
...
//Searching an item in the stack if find return 1 othervise return 0.
int search(int item){
    if(isEmpty()){
